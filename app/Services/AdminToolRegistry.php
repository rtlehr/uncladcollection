        ...
        return [
            [
                ...
                'tools' => [
                    ...
                    $this->tool('homepage-discovery', 'Homepage Discovery', 'Order and configure homepage discovery sections.', '/admin/discovery/homepage', 'LayoutDashboard', 'manage_site_settings', ['homepage','section','recommendation','trending','composition']),
            ...
            [
                ...
                'tools' => [
                    ...
                    $this->tool('social-posts', 'X Posts', 'Draft, schedule, publish, and review posts sent to X.', '/admin/social-posts', 'Send', 'manage_social_posts', ['social','X','Twitter','tweet','post','schedule']),
