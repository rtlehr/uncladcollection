    ...
    private function assetDefinitions(): array
    {
        return [
            ...
            [
                ...
                'offerings' => [
                    $this->offering('personal-use', 'Personal Video License', 'MP4 video for personal projects.', 1999, 5, ['video']),
                    $this->offering('commercial-use', 'Commercial Video License', 'MP4 video for business, marketing, and social media use.', 5999, 10, ['video']),
                    $this->offering('extended-commercial-use', 'Extended Video License', 'MP4 video with extended commercial usage rights.', 11999, null, ['video']),
                ],
            ],
            [
                ...
                'offerings' => [
                    $this->offering('personal-use', 'Personal Mixed-Media License', 'Vector overlay and MP4 teaser for personal projects.', 2499, 5, ['overlay', 'video']),
                    $this->offering('commercial-use', 'Commercial Mixed-Media License', 'Vector, video, and source ZIP for commercial projects.', 7499, 10, ['overlay', 'video', 'bundle']),
                    $this->offering('extended-commercial-use', 'Complete Creative Package', 'All active downloadable files, including future additions.', 14999, null, [], true),
                ],
            ],
            [
