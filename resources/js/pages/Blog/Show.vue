...
const articleImage = computed(() => contentImage(props.blogPost));
                ...
                <section class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <BlogMeta
                            ...
                            :avatar-alt="blogPost.author?.name ?? blogPost.title"
                            :published-date="formatDate(blogPost.published_at)"
                            :reading-time="readingTime"
                            :views-count="blogPost.views_count"
                        />
                    </PageHeader>
                </section>
                ...
                <section class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
                    <div class="grid gap-10 lg:grid-cols-[1fr_280px]">
                        ...
                        <aside class="space-y-6">
                            ...
                            <BlogAuthorCard :author="blogPost.author" />

                            <BlogPostList
                                :title="`More by ${blogPost.author?.name ?? 'this author'}`"
                                :posts="authorPosts"
                            />
