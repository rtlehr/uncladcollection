...
<template><Head :title="`${report.customer.name} Customer Analytics`"/><div class="space-y-8 p-6"><PageHeader :title="report.customer.name" :description="report.customer.email"><template #actions><Button variant="outline" as-child><Link href="/admin/analytics/customers"><ArrowLeft class="mr-2 h-4 w-4"/>All customers</Link></Button></template></PageHeader>
