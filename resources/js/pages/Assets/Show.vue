...
<template>
  ...
  <PublicPageLayout>
    <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <div
        class="grid gap-10 xl:grid-cols-[minmax(0,1fr)_380px] xl:items-start"
      >
        <div>
        ...
        <aside class="xl:sticky xl:top-24">
          ...
          <p
            ...
            class="mt-5 text-base leading-7 text-stone-600 dark:text-stone-300"
          >
            {{ asset.description }}
          </p>
      ...
      <div
        class="mt-10 grid gap-8 xl:grid-cols-[minmax(0,1fr)_minmax(320px,0.8fr)]"
      >
      ...
      <section v-if="relatedAssets.length" class="mt-16">
        <div class="flex items-end justify-between gap-4">
          <div>
            ...
            <h2 class="mt-2 text-2xl font-semibold">Related assets</h2>
          </div>
          <Link
            href="/images"
